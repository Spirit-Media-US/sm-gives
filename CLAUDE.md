...
**Score:** 5/7 · last audited 2026-04-24

**Gaps (2):**
- T2: fetchpriority=high present but no preload in Layout
- T4: fonts — not-selfhost no-display


Run `/home/deploy/bin/perf-traits-audit.sh sm-gives` for full detail. Remediation guidance in [performance-gate.md](/home/deploy/claude-config/rules/performance-gate.md).
<!-- perf-traits:end -->
