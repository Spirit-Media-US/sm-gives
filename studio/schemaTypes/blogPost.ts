export default {
  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        list: [
          { title: 'SMGives', value: 'SMGives' },
          { title: 'Deaf Biblical Ministries', value: 'Deaf Biblical Ministries' },
          { title: 'Hospital Light', value: 'Hospital Light' },
